...
export const articles: Article[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: {
          en: [
            'The measure is not how complete the library looks. It is how often people bypass it. Open the newest product screens and look for detached instances, hard-coded hex values and text that is not using a shared style. Each one is feedback: either the component was missing, or it was too rigid, or it was too hard to find.',
            'Treat the fixes in that order. Missing components get built. Rigid components get another property. Hard-to-find components get renamed to whatever the people searching for them actually typed. A system stays alive because using it is the path of least resistance, not because anyone was told to use it.',
          ],
        },
      },
    ],
    gallery: [
      {
        ...
        alt: {
          en: 'Component library page showing button, input and card components with their variant and boolean properties',
        },
      },
      {
        src: '/images/articles/render-series/gallery-04.png',
        alt: {
          en: 'Type ramp and 4px spacing scale documented side by side in the design system file',
        },
      },
      {
        src: '/images/articles/render-series/gallery-05.png',
        alt: {
          en: 'Do and do-not frames documenting correct and incorrect use of form field components',
        },
      },
    ],
  },
