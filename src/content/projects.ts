...
export const projects: Project[] = [
  {
    ...
    tags: ['uxui'],
    summary: {
      en: 'A task management app concept designed in full light and dark themes from one token set — progress, priority and status readable at a glance without colour doing all the work.',
    },
    thumbnail: shot(
      'zenith',
      'cover',
    ...
    sections: [
      {
        ...
        paragraphs: {
          en: [
            'A cleaning service has no product shot. The thing being bought is a change of state, which is hard to put in a card and impossible to judge from a price alone — the reason this whole category leans so heavily on reviews.',
    ...
    outcome: {
      ...
      paragraphs: {
        en: [
          ...
          'The scope is the honest part of this one. It is a visual exploration of a hero section — useful for what it settles about type pairing, contrast and where to spend a single accent — not a product design project, and not presented as one.',
        ],
      },
    },
