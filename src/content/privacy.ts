...
export const privacySections: {
  ...
  },
  {
    ...
    paragraphs: {
      en: [
        'The contact form has no backend. Nothing is posted to a server, no third-party form service is involved, and no copy of your message is stored on this site. Pressing send opens your own email application with the message already written and addressed to me, so you still decide whether to send it.',
